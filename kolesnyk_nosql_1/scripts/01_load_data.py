...
# 1. Ця функція знаходить файл .env і завантажує змінні з нього в пам'ять програми
load_dotenv()

# 2. Тепер через os.environ ми можемо безпечно дістати наш рядок підключення, 
# не «світячи» пароль прямо в коді файлу 01_load_data.py
